...
@model({
  settings: {
    postgresql: {schema: 'public', table: 'pag_cuo'},
  },
})
export class OwnCreditPayments extends Entity {
  @property({
    type: 'string',
    id: true,
    generated: false,
...
export interface OwnCreditPaymentsRelations {
  // describe navigational properties here
}

export type OwnCreditPaymentsWithRelations = OwnCreditPayments & OwnCreditPaymentsRelations;
