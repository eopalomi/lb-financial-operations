...
@model({
  settings: {
    postgresql: {schema: 'public', table: 'pag_anu_ven'},
  },
})
export class TransferredPaymentCanceled extends Entity {
  @property({
    type: 'number',
    id: true,
    generated: false,
  ...
  constructor(data?: Partial<TransferredPaymentCanceled>) {
    super(data);
  }
}

export interface TransferredPaymentCanceledRelations {
  // describe navigational properties here
}

export type TransferredPaymentCanceledWithRelations = TransferredPaymentCanceled & TransferredPaymentCanceledRelations;
